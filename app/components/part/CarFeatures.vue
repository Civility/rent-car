...
const items = computed(() => {
  ...
  const list = [
    {
      ...
      icon: "👥",
      value: f.seats,
      tooltip: $t("common.features.seats"),
    },
    {
      key: "doors",
      icon: "🚪",
      value: f.doors,
      tooltip: $t("common.features.doors"),
    },
    {
      key: "bags",
      icon: "🧳",
      value: f.bags,
      tooltip: $t("common.features.bags"),
    },
    {
      key: "transmission",
      icon: "⚙️",
      ...
      tooltip:
        f.transmission === "A"
          ? $t("common.features.transmission.A")
          : $t("common.features.transmission.M"),
    },
  ];
  ...
  list.push({
    ...
    tooltip: $t("common.features.age"),
  });

  return list.filter((item) => item.value !== undefined && item.value !== null);
});

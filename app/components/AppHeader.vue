        ...
        >
          ...
          <div class="flex flex-col mb-4">
            <a
              ...
              class="text-sec font-bold text-md hover:underline"
            >
              +30 697 779 5840
            </a>
            <a
          ...
          <p class="text-zinc-300 font-bold text-md">
            Lagina-Lagadas-Thessaloniki <br />
            Greece, 57200 <br />
            <a href="mailto:info@rent-me.gr" class="text-sec hover:underline">
              info@rent-me.gr
            </a>
          </p>
          ...
          <div class="flex gap-4 mt-4">
            <a
              ...
              aria-label="Facebook"
            >
              <UISvg :svg="ICON_FACEBOOK" class="text-sec w-6 h-6" />
            </a>
            <a href="viber://chat?number=%2B306977795840" aria-label="Viber">
              <UISvg :svg="ICON_VIBER" class="text-sec w-6 h-6" />
            </a>
            <a
              ...
              aria-label="WhatsApp"
            >
              <UISvg :svg="ICON_WHATSAPP" class="text-sec w-6 h-6" />
            </a>
          </div>
        </address>
      </nav>

      <div class="flex items-center gap-4 z-60 self-start pt-4">
        <UIBtn
          class="lg:hidden! p-3 text-white hover:bg-white/10 rounded-xl transition-colors active:scale-90"
